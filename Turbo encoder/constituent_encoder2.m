function [systematic_bits, tail_bits, parity_bits] = constituent_encoder2(message_bits)
...
q0_plus = mod(message_bits(bit_index)+q0+q1+q2, 2);
q1_plus = q0;
q2_plus = q1;
...
tail_bits(bit_index) = mod(q0+q1+q2, 2);
